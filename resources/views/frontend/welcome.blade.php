...
<head>
    ...
    <!-- bootstrap css -->
    <link id="rtl-link" rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/bootstrap.css') }}">

    <!-- wow css -->
    <link rel="stylesheet" href="{{ asset('/frontend/asset/animate.min.css') }}" />

    <!-- font-awesome css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/font-awesome.css') }}">

    <!-- feather icon css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/feather-icon.css') }}">

    <!-- slick css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/slick.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/slick-theme.css') }}">

    <!-- Iconly css -->
    <link rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/bulk-style.css') }}">

    <!-- Template css -->
    <link id="color-link" rel="stylesheet" type="text/css" href="{{ asset('/frontend/asset/style.css') }}">
...
<body class="theme-color-2 bg-effect">
                                            ...
                                            <div class="onhover-div">
                                                <ul class="cart-list">
                                                    ...
                                                    <li>
                                                        <div class="drop-cart">
                                                            <a href="product-left-thumbnail.html" class="drop-image">
                                                                <img src="https://themes.pixelstrap.com/fastkart/assets/images/veg-3/home/1.png"
                                                                    class="blur-up lazyload" alt="">
                                                            </a>
            ...
            <div class="row g-4">
                ...
                <div class="col-xxl-3 col-md-4 ratio_medium d-md-block d-none">
                    <div class="home-contain home-small h-100">
                        <div class="h-100">
                            <img src="https://themes.pixelstrap.com/fastkart/assets/images/veg-3/home/1.png" class="img-fluid bg-img blur-up lazyload"
                                alt="">
                        </div>
        ...
        <div class="container-fluid-lg">
            <div class="title title-flex-2">
                ...
                <ul class="nav nav-tabs tab-style-color-2 tab-style-color" id="myTab">
                    <li class="nav-item">
                        <button class="nav-link btn active" id="all-tab" data-bs-toggle="tab"
                    ...
                    <li class="nav-item">
                        <button class="nav-link btn" id="beverage-tab" data-bs-toggle="tab"
                            data-bs-target="#beverage" type="button">Beverage</button>
                    </li>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="https://themes.pixelstrap.com/fastkart/assets/images/veg-3/home/1.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.2s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/7.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.25s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/9.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6 wow fadeInUp" data-wow-delay="0.45s">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/15.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/8.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/14.png" class="img-fluid"
                                            alt="">
                                    </a>
                        ...
                        <div class="col-xxl-2 col-lg-3 col-md-4 col-6">
                            <div class="product-box-4">
                                <div class="product-image">
                                    ...
                                    <a href="product-left-thumbnail.html">
                                        <img src="../assets/images/veg-3/cate1/16.png" class="img-fluid"
                                            alt="">
                                    </a>
            ...
            <div class="slider-3 arrow-slider">
                    ...
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="../assets/images/veg-3/blog/1.jpg" class="img-fluid bg-img"
                                    alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="../assets/images/veg-3/blog/2.jpg" class="img-fluid bg-img"
                                    alt="">
                            </a>
                        </div>
                ...
                <div>
                    <div class="blog-box ratio_50">
                        <div class="blog-box-image">
                            <a href="blog-detail.html">
                                <img src="../assets/images/veg-3/blog/3.jpg" class="img-fluid bg-img"
                                    alt="">
                            </a>
                        </div>
    ...
    <script src="{{ asset('/frontend/js/timer3.js') }}"></script>
    <script src="{{ asset('/frontend/js/timer4.js') }}"></script>
