      ...
      >
        ...
        <div class="flex justify-end">
          <a
            ...
            class="btn btn-red mr-4 py-2 px-4 bg-red-700 text-white rounded-lg"
          >
            Cancel
          </a>
          <button class="btn btn-blue py-2 px-4 text-white rounded-lg bg-blue-700" type="submit">Save</button>
        </div>
      </form>
    </div>
  </div>
