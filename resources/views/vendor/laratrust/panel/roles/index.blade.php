...
@section('content')
  <div class="flex flex-col">
    ...
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div class="mt-4 align-middle inline-block bg-white min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
        <table class="min-w-full">
          <thead>
            <tr>
              <th class="th border p-2 text-left">Id</th>
              <th class="th border p-2 text-left">Display Name</th>
              <th class="th border p-2 text-left">Name</th>
              <th class="th border p-2 text-left"># Permissions</th>
              <th class="th border p-2 text-left"></th>
            </tr>
          </thead>
