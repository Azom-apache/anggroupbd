  ...
  <div class="flex flex-col">
    <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
      <div
        ...
        class="mt-4 align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200 p-4 bg-white"
      >
          ...
          <table class="min-w-full">
            <thead>
              <tr>
                ...
                <th class="th p-2 border text-left">Name</th>
                <th class="th p-2 border text-left"># Roles</th>
                @if(config('laratrust.panel.assign_permissions_to_user'))<th class="th"># Permissions</th>@endif
                <th class="th p-2 border"></th>
              </tr>
            </thead>
