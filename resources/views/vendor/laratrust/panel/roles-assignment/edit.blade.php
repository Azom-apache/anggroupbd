      ...
      >
        ...
        <div class="flex justify-end">
          <a
            ...
            class="btn btn-red mr-4 py-2 px-4 bg-red-700 rounded-lg text-white"
          >
            Cancel
          </a>
          <button class="btn btn-blue py-2 px-4 bg-blue-700 rounded-lg text-white ml-2" type="submit">Save</button>
        </div>
      </form>
    </div>
  </div>
